...
function ProductItem({item, handleOpen}) {
    return (
      ...
      <div onClick={handleOpen} className=" mr-[4%] cursor-pointer  relative mt-[3%] hover:shadow-xl flex flex-col md:flex-row md:space-x-5 space-y-3 md:space-y-0 rounded-xl shadow-lg p-3 max-w-xs md:max-w-3xl mx-auto border border-white bg-white">
